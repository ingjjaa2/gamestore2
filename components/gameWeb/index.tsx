...
import Slider,{sliderData} from '../sliders';
...
const Index = ({gamePage}:{gamePage:game}) => {
    ...
    return (
        <div className="gameWebRoot">
            {/* header */}
            <div className="gameWebHeader">
            ...
            {/* Body */}
            <div className="gameWebBody scrollContainer">
                {/* game Image */}
                <div className="gameImageHeader  animate__animated animate__zoomInUp" style={{backgroundImage:`url(${activeGame?.banneUrl})`}}>
                    <div className="gameImageVideo loadingComponent animate__animated animate__zoomInRight animate__delay-1s">
                            <iframe width="100%" height="100%" src={multimediaList[0]?.url?.replace('watch?v=','embed/')} allowFullScreen={true}/>
                    </div>
                </div>
                {/* Description and Info Box */}
                <div className="gameInfoContainer">
                    <div className="gameSummaryBox animate__animated animate__fadeInLeft">
                    ...
                    <div>
                        <div className="gameInfoIconContainer">
                        ...
                        <div className="gameInfoDetailBox animate__animated animate__fadeInDown">{activeGame?.detail}</div>
                    </div>
                </div>
                {/* Images Slider */}
